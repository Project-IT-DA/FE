    ...
    <>
      <div className="w-full h-full">
        ...
        <div className="absolute top-[5%] w-full h-[15rem] flex flex-col justify-center items-center">
          <span className=" font-bold text-xl text-[#393939] tracking-wide">
            IT에 관한 모든 중고거래 플랫폼
          </span>
